          ...
          <div className="max-w-xl mx-auto">
            <div className="rounded-2xl border border-auto-accent/30 bg-auto-accent/5 p-6 sm:p-8 text-center">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-lg bg-auto-accent px-6 py-3 font-display text-sm font-semibold text-[#09090B] transition-transform hover:scale-105 active:scale-95"
              >

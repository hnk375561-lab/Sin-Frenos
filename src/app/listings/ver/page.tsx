...
function ListingContent() {
  ...
  if (error) return <main className="marketplace-listing-page"><div className="marketplace-listing-shell rounded-3xl border border-[#FFB7D7] bg-[#FFE0ED] p-8 text-center"><h1 className="text-2xl font-extrabold text-[#171130]">No pudimos abrir esta publicación</h1><p className="mt-2 text-sm text-[#D90067]">{error}</p><Link href="/listings" className="marketplace-auth-primary mt-6">Volver a publicaciones</Link></div></main>

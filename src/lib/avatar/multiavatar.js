...
// CommonJS export added only to make the official standalone implementation
// consumable by the app bundle; the generator itself is unchanged.
if (typeof module !== 'undefined') module.exports = multiavatar;
